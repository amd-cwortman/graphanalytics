...
function usage() {
    ...
    echo "  -u : Uninstall Log Similarity demo"
...
if [ $uninstall -eq 1 ]; then
    echo "Uninstalling Log Similarity demo UDFs on all TigerGraph nodes..."
...
echo "Installing Log Similarity demo UDFs on all TigerGraph nodes..."
