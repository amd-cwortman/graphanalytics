...
void inline PhaseLoop_MapHostBuff(long NV,
    ...
    // DDR Settings
#ifndef USE_HBM
    mext_in[0] = {XCL_MEM_DDR_BANK0, buff_host.config0, 0};
    mext_in[1] = {XCL_MEM_DDR_BANK0, buff_host.config1, 0};
    mext_in[2] = {XCL_MEM_DDR_BANK0, axi_offsets, 0};
    mext_in[3] = {XCL_MEM_DDR_BANK0, axi_indices, 0};
    mext_in[4] = {XCL_MEM_DDR_BANK0, axi_weights, 0};
    if (NE_mem_2 > 0) {
        mext_in[3 + 13] = {XCL_MEM_DDR_BANK0, axi_indices2, 0};
        mext_in[4 + 13] = {XCL_MEM_DDR_BANK0, axi_weights2, 0};
    }
    mext_in[5] = {XCL_MEM_DDR_BANK0, axi_colorAxi, 0};
    mext_in[6] = {XCL_MEM_DDR_BANK0, axi_colorInx, 0};
    mext_in[7] = {XCL_MEM_DDR_BANK0, axi_cidPrev, 0};
    mext_in[8] = {XCL_MEM_DDR_BANK0, axi_cidSizePrev, 0};
    mext_in[9] = {XCL_MEM_DDR_BANK0, axi_totPrev, 0};
    mext_in[10] = {XCL_MEM_DDR_BANK0, axi_cidCurr, 0};
    mext_in[11] = {XCL_MEM_DDR_BANK0, axi_cidSizeCurr, 0};
    mext_in[12] = {XCL_MEM_DDR_BANK0, axi_totCurr, 0};
    mext_in[13] = {XCL_MEM_DDR_BANK0, axi_cidSizeUpdate, 0};
    mext_in[14] = {XCL_MEM_DDR_BANK0, axi_totUpdate, 0};
...
void ConsumingOnePhase_prune(GLV* pglv_iter,
    ...
    std::cout << "\tPhaseLoop_UsingFPGA_Prep_Read_buff_host Done" << std::endl;
}
